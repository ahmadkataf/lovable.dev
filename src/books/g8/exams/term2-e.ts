  ...
  sections: [
    {
      ...
      questions: [
        { n: 1, kind: 'mcq', prompt: "Sami's knee was hurt in ___.", promptAr: 'أُصيبت ركبة سامي في ___.', options: ['the final', 'a road accident', 'a sports lesson', 'a race'], answer: 1, explainAr: 'النص: "he had a road accident on his way home. His knee was badly hurt" — أُصيبت ركبته في حادث سير.' },
        { n: 2, kind: 'mcq', prompt: 'After the accident, Sami ___.', promptAr: 'بعد الحادث، ___ سامي.', options: ['stayed at home and thought about stopping', 'went back to running immediately', 'won the final of the competition', 'became a sports teacher'], answer: 0, explainAr: 'النص: "For weeks, he stayed at home and did nothing ... he often thought about quitting" — والتفكير في quitting يعني التفكير في التوقف.' },
        { n: 3, kind: 'mcq', prompt: 'What does "who" in the text refer to?', promptAr: 'إلامَ تعود كلمة "who" في النص؟', options: ['the doctors', 'Sami', 'his elder brother', 'his friends'], answer: 2, explainAr: 'الجملة: "his elder brother, who was a sports teacher" — فكلمة who تعود على أخيه الأكبر.' },
        { n: 4, kind: 'mcq', prompt: '"Thrilled" is the opposite of:', promptAr: 'كلمة "Thrilled" (مسرور جداً) عكسها:', options: ['able-bodied', 'happy', 'competitive', 'sad'], answer: 3, explainAr: 'thrilled = مسرور جداً (extremely pleased)، وعكسها sad = حزين. أما happy فقريبة من معناها.' },
        { n: 5, kind: 'mcq', prompt: '"Obstacle" means ___.', promptAr: 'كلمة "Obstacle" تعني ___.', options: ['something that makes it difficult to achieve something', 'the last race in a competition', 'something done successfully with effort', 'a detailed idea of how to do something'], answer: 0, explainAr: 'obstacle = عقبة، أي شيء يجعل تحقيق ما تريد صعباً. أما الخيارات الأخرى فهي معاني plan و final و achievement.' },
      ],
    },
    {
      letter: 'B',
    ...
    },
    {
      ...
      marks: 200,
      questions: [
        { n: 11, kind: 'mcq', topic: 'grammar', prompt: 'Math is ___ than English for me.', promptAr: 'الرياضيات ___ من الإنجليزية بالنسبة لي.', options: ['more difficulter', 'the most difficult', 'difficulter', 'more difficult'], answer: 3, explainAr: 'نقارن بين شيئين ومعنا than، وdifficult صفة طويلة فنستخدم more: more difficult.' },
        { n: 12, kind: 'mcq', topic: 'grammar', prompt: 'My marks this term are ___ than my marks last term.', promptAr: 'علاماتي هذا الفصل ___ من علاماتي في الفصل الماضي.', options: ['best', 'better', 'gooder', 'more good'], answer: 1, explainAr: 'good صفة شاذة، وصيغة المقارنة منها better (مع than).' },
        { n: 13, kind: 'mcq', topic: 'grammar', prompt: 'Summer is ___ season of the year.', promptAr: 'الصيف ___ فصل في السنة.', options: ['the most hot', 'the hotest', 'the hottest', 'hotter'], answer: 2, explainAr: 'نقارن الصيف بكل فصول السنة فنستخدم التفضيل. hot فيها حرف علة واحد + حرف ساكن فنضاعف الأخير: the hottest.' },
        ...
        { n: 15, kind: 'mcq', topic: 'grammar', prompt: "I can't swim well. I wish I ___ swim like Natalie.", promptAr: 'لا أستطيع السباحة جيداً. أتمنى لو ___ السباحة مثل ناتالي.', options: ['will', 'would', 'can', 'could'], answer: 3, explainAr: 'نتمنى قدرة لا نملكها الآن، فنستخدم wish + could.' },
        { n: 16, kind: 'mcq', topic: 'grammar', prompt: 'My father smokes a lot. I wish he ___ so much.', promptAr: 'أبي يدخّن كثيراً. أتمنى لو ___ بهذا القدر.', options: ['not smoke', "won't smoke", "didn't smoke", "doesn't smoke"], answer: 2, explainAr: 'نتمنى عكس واقع حاضر، والنفي بعد wish يكون بالماضي: didn\'t + الفعل المجرد: didn\'t smoke.' },
        { n: 17, kind: 'mcq', topic: 'grammar', prompt: "Mouayyad didn't go to school yesterday, ___?", promptAr: 'لم يذهب مؤيّد إلى المدرسة البارحة، ___؟', options: ['did he', 'was he', 'does he', "didn't he"], answer: 0, explainAr: 'الجملة منفية (didn\'t) فالذيل مثبت بالفعل المساعد نفسه مع الضمير he: did he?' },
        { n: 18, kind: 'mcq', topic: 'grammar', prompt: 'Lamar can speak French, ___?', promptAr: 'لمار تستطيع التكلّم بالفرنسية، ___؟', options: ['can she', "isn't she", "doesn't she", "can't she"], answer: 3, explainAr: 'الجملة مثبتة وفيها الفعل الناقص can، فالذيل منفي بـ can نفسه: can\'t she?' },
        { n: 19, kind: 'mcq', topic: 'grammar', prompt: 'Last night, my uncle saw ___ UFO in the sky.', promptAr: 'ليلة البارحة رأى عمّي ___ جسماً طائراً مجهولاً في السماء.', options: ['no article', 'a', 'the', 'an'], answer: 1, explainAr: 'العبرة بالصوت لا بالحرف: UFO تُلفظ /juː-ef-oʊ/ وتبدأ بصوت ساكن (مثل a university)، ونذكره أول مرة: a UFO.' },
        { n: 20, kind: 'mcq', topic: 'grammar', prompt: 'The strange lights ___ by many people last night.', promptAr: 'الأضواء الغريبة ___ من قِبَل كثير من الناس ليلة البارحة.', options: ['saw', 'are seen', 'were seen', 'were seeing'], answer: 2, explainAr: 'الأضواء لا ترى بل تُرى (by many people)، والزمن ماضٍ (last night) والفاعل جمع: were + التصريف الثالث: were seen.' },
        { n: 21, kind: 'mcq', topic: 'pronunciation', prompt: 'The word that has three syllables is:', promptAr: 'الكلمة التي تتكون من ثلاثة مقاطع صوتية هي:', options: ['confident', 'fashion', 'remarkable', 'trend'], answer: 0, explainAr: 'con-fi-dent = 3 مقاطع. أما fash-ion فمقطعان، و trend مقطع واحد، و re-mark-a-ble أربعة مقاطع.' },
        { n: 22, kind: 'mcq', topic: 'pronunciation', prompt: 'The word that has /tʃ/ sound is:', promptAr: 'الكلمة التي تحتوي على الصوت /tʃ/ هي:', options: ['sure', 'sheep', 'cheese', 'share'], answer: 2, explainAr: 'ch في cheese تُلفظ /tʃ/ (تش). أما share و sheep ففيهما /ʃ/ (ش)، و sure يُلفظ فيها s بصوت /ʃ/.' },
        ...
        { n: 24, kind: 'mcq', topic: 'grammar', prompt: 'We usually have ___ breakfast at seven o\'clock.', promptAr: 'نتناول عادةً ___ الفطور في الساعة السابعة.', options: ['no article', 'a', 'an', 'the'], answer: 0, explainAr: 'لا نستخدم أداة قبل أسماء الوجبات (breakfast, lunch, dinner): have breakfast.' },
        { n: 25, kind: 'mcq', topic: 'grammar', prompt: 'This mystery cannot ___ easily.', promptAr: 'هذا اللغز لا يمكن ___ بسهولة.', options: ['explained', 'explain', 'be explaining', 'be explained'], answer: 3, explainAr: 'المبني للمجهول مع الأفعال الناقصة: cannot + be + التصريف الثالث: cannot be explained.' },
        { n: 26, kind: 'mcq', topic: 'wordform', prompt: 'Hala believes in herself. She is a ___ girl.', promptAr: 'هالة تؤمن بنفسها. إنها فتاة ___.', options: ['confident', 'confide', 'confidently', 'confidence'], answer: 0, explainAr: 'قبل الاسم (girl) نحتاج صفة: confident (واثقة). أما confidence فاسم، و confidently حال.' },
        { n: 27, kind: 'mcq', topic: 'vocab', prompt: 'Physically healthy, fit and strong:', promptAr: 'سليم الجسم ولائق وقوي:', options: ['promising', 'disabled', 'able-bodied', 'qualified'], answer: 2, explainAr: 'able-bodied = سليم الجسم وقوي، وعكسها disabled (الوحدة التاسعة).' },
        { n: 28, kind: 'mcq', topic: 'vocab', prompt: 'Shoes, boots, etc.:', promptAr: 'الأحذية والجزمات وما شابهها:', options: ['accessories', 'footwear', 'cardigan', 'jeans'], answer: 1, explainAr: 'footwear = الأحذية بأنواعها (الوحدة الثامنة). أما accessories فهي الإكسسوارات كالحقائب والأحزمة.' },
        { n: 29, kind: 'mcq', topic: 'vocab', prompt: 'A creature from outer space is called ___.', promptAr: 'المخلوق القادم من الفضاء الخارجي يسمّى ___.', options: ['pilot', 'pelican', 'researcher', 'alien'], answer: 3, explainAr: 'alien = كائن فضائي (الوحدة الثانية عشرة).' },
        { n: 30, kind: 'mcq', topic: 'vocab', prompt: 'The yellow part of an egg is known as ___.', promptAr: 'الجزء الأصفر من البيضة يُعرف بـ ___.', options: ['surface', 'shelf', 'yolk', 'saucer'], answer: 2, explainAr: 'yolk = صفار البيض (الوحدة الحادية عشرة).' },
      ],
    },
    {
      letter: 'D',
      ...
      marks: 40,
      questions: [
        { n: 31, kind: 'ask', prompt: 'Rami stopped running {because he hurt his knee}.', promptAr: 'توقّف رامي عن الجري لأنه آذى ركبته.', options: ['Why did Rami stopped running?', 'When did Rami stop running?', 'Why Rami stopped running?', 'Why did Rami stop running?'], answer: 3, explainAr: 'نسأل عن السبب (because ...) فنستخدم Why، والفعل ماضٍ فنستخدم did + الفعل المجرد: Why did Rami stop running?' },
        { n: 32, kind: 'ask', prompt: 'Kenneth Arnold saw {nine} objects in the sky.', promptAr: 'رأى كينيث أرنولد تسعة أجسام في السماء.', options: ['How much objects did Kenneth Arnold see?', 'How many objects did Kenneth Arnold see?', 'What did Kenneth Arnold see?', 'How many objects Kenneth Arnold saw?'], answer: 1, explainAr: 'نسأل عن عدد شيء معدود (nine objects) فنستخدم How many، ثم did + الفاعل + الفعل المجرد.' },
        { n: 33, kind: 'ask', prompt: 'The strange sounds were heard {in an old house}.', promptAr: 'سُمعت الأصوات الغريبة في بيت قديم.', options: ['Where were the strange sounds heard?', 'Where did the strange sounds heard?', 'Where the strange sounds were heard?', 'When were the strange sounds heard?'], answer: 0, explainAr: 'نسأل عن المكان فنستخدم Where، والجملة مبنية للمجهول فنقدّم were على الفاعل: Where were the strange sounds heard?' },
        { n: 34, kind: 'ask', prompt: 'Bayan {reviewed her plan}.', promptAr: 'راجعت بيان خطّتها.', options: ['Who reviewed her plan?', 'What Bayan did?', 'What did Bayan review?', 'What did Bayan do?'], answer: 3, explainAr: 'المسطّر هو الفعل وما بعده (ما فعلته بيان)، فنسأل بـ What did ... do: What did Bayan do?' },
      ],
    },
    {
      letter: 'E',
