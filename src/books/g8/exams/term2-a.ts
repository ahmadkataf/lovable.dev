  ...
  sections: [
    {
      ...
      questions: [
        { n: 1, kind: 'mcq', prompt: "Reem's teachers say she is ___.", promptAr: 'يقول معلّمو ريم إنها ___.', options: ['shy and quiet', 'a real chatterbox', 'taller than Rama', 'more elegant than her sister'], answer: 1, explainAr: 'النص: "her teachers say she is a real chatterbox" — أي ثرثارة حقاً. أما الخجل والهدوء والأناقة والطول فهي صفات راما.' },
        ...
        { n: 3, kind: 'mcq', prompt: 'What does "them" in the text refer to?', promptAr: 'إلامَ تعود كلمة "them" في النص؟', options: ['most people', 'Rama and Reem', 'brown eyes', 'round faces'], answer: 1, explainAr: 'الجملة: "They look like each other so much that most people can\'t tell them apart" — الناس لا يميّزون بين التوأمين، فكلمة them تعود على راما وريم.' },
        { n: 4, kind: 'mcq', prompt: '"Shy" is the opposite of:', promptAr: 'كلمة "Shy" (خجول) عكسها:', options: ['quiet', 'talkative', 'generous', 'fair'], answer: 1, explainAr: 'shy = خجول قليل الكلام مع الناس، وعكسها talkative (كثير الكلام) — والنص نفسه يقابل بين راما الخجولة وريم الأكثر كلاماً. أما quiet فمعناها قريب من shy.' },
        { n: 5, kind: 'mcq', prompt: '"Generous" means ___.', promptAr: 'كلمة "Generous" تعني ___.', options: ['willing to give and share', 'attractive and pleasant to look at', 'nervous and quiet with other people', 'light in colour'], answer: 0, explainAr: 'generous = كريم، أي مستعد للعطاء والمشاركة (willing to give and share). الخيار b معنى good-looking، و c معنى shy، و d معنى fair.' },
      ],
    },
    {
      letter: 'B',
    ...
    },
    {
      ...
      marks: 200,
      questions: [
        { n: 11, kind: 'mcq', topic: 'grammar', prompt: 'This exam was ___ than the last one.', promptAr: 'كان هذا الامتحان ___ من الامتحان السابق.', options: ['difficult', 'more difficult', 'difficulter', 'the most difficult'], answer: 1, explainAr: 'نقارن بين شيئين (than) والصفة طويلة (difficult) فنستخدم more + الصفة: more difficult. لا نضيف -er للصفات الطويلة، و the most للتفضيل لا للمقارنة.' },
        { n: 12, kind: 'mcq', topic: 'grammar', prompt: 'Lamar is ___ girl in our class.', promptAr: 'لمار هي ___ فتاة في صفّنا.', options: ['funnier', 'the funnyest', 'funniest', 'the funniest'], answer: 3, explainAr: 'نقارن لمار بكل فتيات الصف (in our class) فنستخدم صيغة التفضيل مع the. والصفة المنتهية بـ y تتحوّل y إلى i ثم نضيف -est: the funniest.' },
        { n: 13, kind: 'mcq', topic: 'grammar', prompt: "Bayan hasn't got a bike. She wishes she ___ a bike.", promptAr: 'ليس لدى بيان درّاجة. تتمنى لو أن لديها درّاجة.', options: ['had', 'has', 'will have', 'have'], answer: 0, explainAr: 'نتمنى شيئاً غير حقيقي في الحاضر فنستخدم wish + الماضي البسيط: had.' },
        { n: 14, kind: 'mcq', topic: 'grammar', prompt: 'Layan is from Homs, ___?', promptAr: 'ليان من حمص، أليس كذلك؟', options: ['is she', "doesn't she", "isn't she", "isn't Layan"], answer: 2, explainAr: 'الجملة مثبتة فيكون السؤال الذيلي منفياً، بالفعل المساعد نفسه (is)، وفاعل السؤال ضمير لا اسم: isn\'t she.' },
        { n: 15, kind: 'mcq', topic: 'grammar', prompt: 'Basel is ___ university student.', promptAr: 'باسل طالب جامعي.', options: ['an', 'a', 'the', '(no article)'], answer: 1, explainAr: 'university تبدأ بحرف u لكن تُلفظ بصوت ساكن /j/ (يو)، والعبرة بالصوت لا بالحرف، فنستخدم a: a university student.' },
        { n: 16, kind: 'mcq', topic: 'grammar', prompt: 'Arabic ___ in many countries.', promptAr: 'تُتكلَّم اللغة العربية في بلدان كثيرة.', options: ['speaks', 'spoke', 'is speaking', 'is spoken'], answer: 3, explainAr: 'اللغة لا تتكلّم بنفسها بل يتكلّمها الناس، فنستخدم المبني للمجهول في المضارع البسيط: is + التصريف الثالث: is spoken.' },
        { n: 17, kind: 'mcq', topic: 'grammar', prompt: 'Your handwriting is ___ than mine.', promptAr: 'خطّك ___ من خطّي.', options: ['good', 'better', 'best', 'more good'], answer: 1, explainAr: 'good صفة شاذة، ومقارنتها better (ثم the best للتفضيل). ومعنا than فنحتاج صيغة المقارنة: better.' },
        ...
        { n: 19, kind: 'mcq', topic: 'grammar', prompt: "They didn't visit the exhibition, ___?", promptAr: 'لم يزوروا المعرض، أليس كذلك؟', options: ['did they', "didn't they", 'do they', 'were they'], answer: 0, explainAr: 'الجملة منفية بالفعل المساعد didn\'t (ماضٍ) فيكون السؤال الذيلي مثبتاً بالفعل نفسه: did they.' },
        { n: 20, kind: 'mcq', topic: 'grammar', prompt: 'The old castle ___ hundreds of years ago.', promptAr: 'بُنيت القلعة القديمة منذ مئات السنين.', options: ['built', 'is built', 'was built', 'was building'], answer: 2, explainAr: 'القلعة لم تبنِ نفسها (مبني للمجهول)، والحدث في الماضي (ago)، فنستخدم was + التصريف الثالث: was built.' },
        { n: 21, kind: 'mcq', topic: 'pronunciation', prompt: 'The word that has three syllables is:', promptAr: 'الكلمة المؤلفة من ثلاثة مقاطع صوتية هي:', options: ['fashion', 'elegant', 'trend', 'exhibition'], answer: 1, explainAr: 'el-e-gant ثلاثة مقاطع. أما fash-ion فمقطعان، و trend مقطع واحد، و ex-hi-bi-tion أربعة مقاطع.' },
        { n: 22, kind: 'mcq', topic: 'pronunciation', prompt: 'The word that has /v/ sound is:', promptAr: 'الكلمة التي فيها الصوت /v/ هي:', options: ['safe', 'off', 'of', 'life'], answer: 2, explainAr: 'حرف f في كلمة of يُلفظ /v/ (/əv/). أما safe و off و life فتُلفظ بالصوت /f/.' },
        { n: 23, kind: 'mcq', topic: 'pronunciation', prompt: 'The word that has /ʃ/ sound is:', promptAr: 'الكلمة التي فيها الصوت /ʃ/ (ش) هي:', options: ['chair', 'cheese', 'church', 'sugar'], answer: 3, explainAr: 'حرف s في sugar يُلفظ /ʃ/ (ش) مثل sure. أما ch في chair و cheese و church فيُلفظ /tʃ/ (تش).' },
        { n: 24, kind: 'mcq', topic: 'grammar', prompt: 'This is ___ sofa in our house.', promptAr: 'هذه ___ أريكة في بيتنا.', options: ['the most comfortable', 'more comfortable', 'the comfortablest', 'most comfortable'], answer: 0, explainAr: 'نقارن الأريكة بكل أرائك البيت فنستخدم التفضيل، والصفة طويلة فنقول the most + الصفة: the most comfortable (ولا بد من the).' },
        { n: 25, kind: 'mcq', topic: 'grammar', prompt: '___ sun rises in the east.', promptAr: 'تشرق الشمس من الشرق.', options: ['A', 'An', 'The', '(no article)'], answer: 2, explainAr: 'نستخدم the مع الأشياء الوحيدة من نوعها مثل the sun و the world.' },
        { n: 26, kind: 'mcq', topic: 'wordform', prompt: 'Rama is ___ about drawing; she draws every day.', promptAr: 'راما شغوفة بالرسم؛ فهي ترسم كل يوم.', options: ['passion', 'passionate', 'passionately', 'passions'], answer: 1, explainAr: 'بعد فعل الكون is نحتاج صفة: passionate (شغوف). أما passion فاسم، و passionately ظرف.' },
        { n: 27, kind: 'mcq', topic: 'vocab', prompt: 'The daughter of your brother or sister:', promptAr: 'ابنة أخيك أو أختك:', options: ['bride', 'niece', 'cardigan', 'clerk'], answer: 1, explainAr: 'niece = ابنة الأخ أو ابنة الأخت (كلمة من الوحدة السابعة).' },
        { n: 28, kind: 'mcq', topic: 'vocab', prompt: 'An event that makes it difficult for you to achieve something:', promptAr: 'حدث يجعل من الصعب عليك تحقيق شيء ما:', options: ['goal', 'passion', 'obstacle', 'trend'], answer: 2, explainAr: 'obstacle = عقبة (كلمة من الوحدة التاسعة).' },
        { n: 29, kind: 'mcq', topic: 'vocab', prompt: 'A person who makes things from wood is called ___.', promptAr: 'الشخص الذي يصنع الأشياء من الخشب يُسمّى ___.', options: ['carpenter', 'blacksmith', 'designer', 'pilot'], answer: 0, explainAr: 'carpenter = النجّار. أما blacksmith فهو الحدّاد الذي يصنع الأشياء من الحديد (كلمتان من الوحدة السابعة).' },
        { n: 30, kind: 'mcq', topic: 'vocab', prompt: 'The ability to move objects without touching them is known as ___.', promptAr: 'القدرة على تحريك الأشياء دون لمسها تُعرف بـ ___.', options: ['telepathy', 'healing', 'observation', 'telekinesis'], answer: 3, explainAr: 'telekinesis = التحريك الذهني (كلمة من الوحدة الحادية عشرة). أما telepathy فهي قراءة أفكار الآخرين.' },
      ],
    },
    {
      letter: 'D',
      ...
      marks: 40,
      questions: [
        { n: 31, kind: 'ask', prompt: '{Rama} is taller than Reem.', promptAr: 'راما أطول من ريم.', options: ['Who is taller than Reem?', 'What is taller than Reem?', 'Who taller is than Reem?', 'Who does taller than Reem?'], answer: 0, explainAr: 'نسأل عن شخص في موقع الفاعل فنستخدم Who دون تغيير ترتيب الجملة: Who is taller than Reem?' },
        { n: 32, kind: 'ask', prompt: 'The exhibition was held {last week}.', promptAr: 'أُقيم المعرض الأسبوع الماضي.', options: ['Where was the exhibition held?', 'When did the exhibition held?', 'When was the exhibition held?', 'When the exhibition was held?'], answer: 2, explainAr: 'نسأل عن الزمن (last week) بـ When، والجملة مبنية للمجهول في الماضي فنقدّم was على الفاعل: When was the exhibition held?' },
        { n: 33, kind: 'ask', prompt: 'Karam swims {three times} a week.', promptAr: 'يسبح كرم ثلاث مرات في الأسبوع.', options: ['How many times Karam swims a week?', 'How much times does Karam swim a week?', 'How many times is Karam swim a week?', 'How many times does Karam swim a week?'], answer: 3, explainAr: 'نسأل عن عدد (three times) بـ How many، والفعل مضارع بسيط مع he فنستخدم does + الفعل المجرد: How many times does Karam swim a week?' },
        { n: 34, kind: 'ask', prompt: '{Yes, she wishes she were taller.}', promptAr: 'نعم، هي تتمنى لو كانت أطول.', options: ['Is she wish she were taller?', 'Does she wish she were taller?', 'Did she wish she were taller?', 'What does she wish?'], answer: 1, explainAr: 'الجواب يبدأ بـ Yes فهو جواب سؤال نعم/لا. الفعل wishes مضارع بسيط مع she فنسأل بـ Does + الفعل المجرد: Does she wish she were taller?' },
      ],
    },
    {
      letter: 'E',
