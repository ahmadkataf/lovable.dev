  ...
  sections: [
    {
      ...
      questions: [
        { n: 1, kind: 'mcq', prompt: 'The photos of the light were taken by ___.', promptAr: 'التُقطت صور الضوء من قِبَل ___.', options: ['a researcher', 'a young farmer', 'a pilot', 'the government'], answer: 1, explainAr: 'النص: "Photos of the light were taken by a young farmer".' },
        { n: 2, kind: 'mcq', prompt: 'The researcher thought that ___.', promptAr: 'اعتقد الباحث أن ___.', options: ['the light was an alien spaceship', 'nobody could explain the light', 'the light was not a UFO but a natural thing', 'the government kept the truth secret'], answer: 2, explainAr: 'قال الباحث إن الضوء "was not a spaceship at all" وإنه على الأرجح نوع من البرق، أي شيء طبيعي لا جسم طائر مجهول. أما الخياران a و b فهما رأي القرويين، و d رأي من ينكرون تفسيره.' },
        { n: 3, kind: 'mcq', prompt: 'What does "He" in the text refer to?', promptAr: 'إلامَ تعود كلمة "He" في النص؟', options: ['the young farmer', 'an alien', 'the researcher', 'the pilot'], answer: 2, explainAr: 'الجملة السابقة: "the photos were studied by a researcher from the university. He said that ..." — فكلمة He تعود على الباحث (the researcher).' },
        { n: 4, kind: 'mcq', prompt: '"Secret" is the opposite of:', promptAr: 'كلمة "Secret" (سرّي) عكسها:', options: ['hidden', 'public', 'mysterious', 'unknown'], answer: 1, explainAr: 'secret = سرّي مخفيّ عن الآخرين، وعكسها public (علني يعرفه الجميع). أما hidden فمعناها قريب من secret.' },
        { n: 5, kind: 'mcq', prompt: '"Deny" means ___.', promptAr: 'كلمة "Deny" تعني ___.', options: ['to say that something is not true', 'to make something clear', 'to move to another place', 'to look like'], answer: 0, explainAr: 'deny = يُنكر، أي يقول إن شيئاً ما غير صحيح. الخيار b معنى clarify، و c معنى migrate، و d معنى resemble.' },
      ],
    },
    {
      letter: 'B',
    ...
    },
    {
      ...
      marks: 200,
      questions: [
        { n: 11, kind: 'mcq', topic: 'grammar', prompt: 'My new school is ___ from my house than my old school.', promptAr: 'مدرستي الجديدة ___ عن بيتي من مدرستي القديمة.', options: ['far', 'more far', 'farthest', 'farther'], answer: 3, explainAr: 'far صفة شاذة: far → farther → the farthest. ومعنا than فنحتاج صيغة المقارنة: farther.' },
        { n: 12, kind: 'mcq', topic: 'grammar', prompt: 'Mulham is ___ player in the team.', promptAr: 'ملهم هو ___ لاعب في الفريق.', options: ['better', 'the best', 'the goodest', 'the better'], answer: 1, explainAr: 'نقارن ملهم بكل لاعبي الفريق (in the team) فنستخدم التفضيل. good صفة شاذة: good → better → the best.' },
        { n: 13, kind: 'mcq', topic: 'grammar', prompt: 'My father smokes a lot. I wish he ___ smoke.', promptAr: 'أبي يدخّن كثيراً. أتمنى لو أنه لا يدخّن.', options: ["doesn't", "won't", "didn't", "isn't"], answer: 2, explainAr: 'نتمنى عكس حقيقة في الحاضر فنرجع بعد wish خطوة إلى الماضي: I wish he didn\'t smoke.' },
        { n: 14, kind: 'mcq', topic: 'grammar', prompt: "Lamar and Layan aren't at school today, ___?", promptAr: 'لمار وليان ليستا في المدرسة اليوم، أليس كذلك؟', options: ['are they', "aren't they", 'do they', 'is she'], answer: 0, explainAr: 'الجملة منفية بـ aren\'t فيكون السؤال الذيلي مثبتاً بالفعل نفسه، والفاعل جمع فنستخدم they: are they.' },
        { n: 15, kind: 'mcq', topic: 'grammar', prompt: 'Damascus is one of the oldest cities in ___ world.', promptAr: 'دمشق من أقدم المدن في العالم.', options: ['a', 'an', '(no article)', 'the'], answer: 3, explainAr: 'العالم شيء وحيد من نوعه فنستخدم the: in the world.' },
        { n: 16, kind: 'mcq', topic: 'grammar', prompt: 'Many ancient remains ___ in Syria every year.', promptAr: 'تُكتشف آثار قديمة كثيرة في سوريا كل عام.', options: ['discover', 'are discovered', 'discovered', 'are discovering'], answer: 1, explainAr: 'الآثار لا تكتشف نفسها بل يكتشفها الناس، فنستخدم المبني للمجهول في المضارع البسيط (every year) مع فاعل جمع: are + التصريف الثالث: are discovered.' },
        { n: 17, kind: 'mcq', topic: 'grammar', prompt: 'Hala is ___ than her brother.', promptAr: 'هالة ___ من أخيها.', options: ['funnyer', 'more funny', 'funnier', 'the funniest'], answer: 2, explainAr: 'الصفة funny تنتهي بـ y فتتحوّل y إلى i ثم نضيف -er: funnier. ومعنا than فنحتاج المقارنة لا التفضيل.' },
        { n: 18, kind: 'mcq', topic: 'grammar', prompt: "I'm not a good swimmer. I wish I ___ a good swimmer.", promptAr: 'لست سبّاحاً جيداً. أتمنى لو كنت سبّاحاً جيداً.', options: ['were', 'am', 'be', 'will be'], answer: 0, explainAr: 'بعد wish نرجع خطوة إلى الماضي، ومع فعل الكون نستخدم were مع كل الضمائر: I wish I were ...' },
        { n: 19, kind: 'mcq', topic: 'grammar', prompt: 'Basel will come to the party, ___?', promptAr: 'سيأتي باسل إلى الحفلة، أليس كذلك؟', options: ['will he', "doesn't he", "isn't he", "won't he"], answer: 3, explainAr: 'الجملة مثبتة بالفعل will فيكون السؤال الذيلي منفياً بالفعل نفسه: won\'t he.' },
        { n: 20, kind: 'mcq', topic: 'grammar', prompt: 'This photo ___ by my uncle in 2010.', promptAr: 'التُقطت هذه الصورة من قِبَل عمّي عام 2010.', options: ['took', 'was taken', 'is taking', 'was took'], answer: 1, explainAr: 'الصورة لا تلتقط نفسها، ومعنا by و 2010 (ماضٍ)، فنستخدم المبني للمجهول: was + التصريف الثالث taken (لا took).' },
        { n: 21, kind: 'mcq', topic: 'pronunciation', prompt: 'The word that has one syllable is:', promptAr: 'الكلمة المؤلفة من مقطع صوتي واحد هي:', options: ['makeup', 'twist', 'hotel', 'rabbit'], answer: 1, explainAr: 'twist مقطع واحد. أما make-up و ho-tel و rab-bit فكل منها مقطعان.' },
        { n: 22, kind: 'mcq', topic: 'pronunciation', prompt: 'The word that has both /f/ and /v/ sounds is:', promptAr: 'الكلمة التي فيها الصوتان /f/ و /v/ معاً هي:', options: ['feet', 'vet', 'five', 'off'], answer: 2, explainAr: 'five تبدأ بـ /f/ وتنتهي بـ /v/. أما feet و off ففيهما /f/ فقط، و vet فيها /v/ فقط.' },
        { n: 23, kind: 'mcq', topic: 'pronunciation', prompt: 'The word that has /tʃ/ sound is:', promptAr: 'الكلمة التي فيها الصوت /tʃ/ (تش) هي:', options: ['share', 'sure', 'ship', 'chin'], answer: 3, explainAr: 'ch في chin تُلفظ /tʃ/ (تش). أما sh في share و ship، و s في sure فتُلفظ /ʃ/ (ش).' },
        { n: 24, kind: 'mcq', topic: 'grammar', prompt: 'Maths is ___ subject for me.', promptAr: 'الرياضيات هي ___ مادة بالنسبة لي.', options: ['the most difficult', 'the difficultest', 'more difficult', 'most difficult'], answer: 0, explainAr: 'نقارن الرياضيات بكل المواد فنستخدم التفضيل، والصفة طويلة فنقول the most + الصفة: the most difficult.' },
        { n: 25, kind: 'mcq', topic: 'grammar', prompt: 'Mouayyad wants to be ___ pilot.', promptAr: 'يريد مؤيّد أن يصبح طياراً.', options: ['an', 'a', 'the', '(no article)'], answer: 1, explainAr: 'نستخدم a قبل الاسم المفرد المعدود الذي يبدأ بصوت ساكن، ومنها أسماء المهن: a pilot.' },
        { n: 26, kind: 'mcq', topic: 'wordform', prompt: 'The light in the sky was very ___.', promptAr: 'كان الضوء في السماء غامضاً جداً.', options: ['mystery', 'mysteriously', 'mysterious', 'mysteries'], answer: 2, explainAr: 'بعد was very نحتاج صفة تصف الضوء: mysterious (غامض). أما mystery فاسم (لغز)، و mysteriously ظرف.' },
        { n: 27, kind: 'mcq', topic: 'vocab', prompt: 'A strong wish to achieve something:', promptAr: 'رغبة قوية في تحقيق شيء ما:', options: ['excuse', 'setback', 'existence', 'ambition'], answer: 3, explainAr: 'ambition = طموح (كلمة من الوحدة العاشرة).' },
        { n: 28, kind: 'mcq', topic: 'vocab', prompt: 'A person who studies something carefully to find out facts:', promptAr: 'شخص يدرس شيئاً بعناية ليكتشف الحقائق:', options: ['pilot', 'researcher', 'housewife', 'clerk'], answer: 1, explainAr: 'researcher = باحث (كلمة من الوحدة الثانية عشرة).' },
        { n: 29, kind: 'mcq', topic: 'vocab', prompt: 'Light in colour (hair or skin):', promptAr: 'فاتح اللون (للشعر أو البشرة):', options: ['fair', 'round', 'straight', 'bright'], answer: 0, explainAr: 'fair = أشقر أو فاتح اللون (كلمة من الوحدة السابعة). أما straight فتعني أملس غير مجعّد، و bright لامع.' },
    ...
    },
    {
      ...
      marks: 40,
      questions: [
        { n: 31, kind: 'ask', prompt: 'The farmer saw {three} strange lights in the sky.', promptAr: 'رأى المزارع ثلاثة أضواء غريبة في السماء.', options: ['How much strange lights did the farmer see in the sky?', 'How many strange lights did the farmer see in the sky?', 'How many strange lights did the farmer saw in the sky?', 'How many strange lights the farmer saw in the sky?'], answer: 1, explainAr: 'نسأل عن عدد شيء معدود بـ How many، والفعل في الماضي فنستخدم did + الفعل المجرد see: How many strange lights did the farmer see in the sky?' },
        { n: 32, kind: 'ask', prompt: "Bayan's story won {the first prize}.", promptAr: 'فازت قصة بيان بالجائزة الأولى.', options: ["Who did Bayan's story win?", "What does Bayan's story win?", "What Bayan's story won?", "What did Bayan's story win?"], answer: 3, explainAr: 'نسأل عن شيء (the first prize) في موقع المفعول به بـ What، والفعل في الماضي فنستخدم did + الفعل المجرد: What did Bayan\'s story win?' },
        { n: 33, kind: 'ask', prompt: 'The photos were taken {by a young farmer}.', promptAr: 'التُقطت الصور من قِبَل مزارع شاب.', options: ['Who were the photos taken by?', 'What were the photos taken by?', 'Who did the photos taken by?', 'Who the photos were taken by?'], answer: 0, explainAr: 'نسأل عن الشخص الذي قام بالفعل (by a young farmer) بـ Who ... by، والجملة مبنية للمجهول بـ were فنقدّمها على الفاعل: Who were the photos taken by?' },
        { n: 34, kind: 'ask', prompt: 'Mulham went to the doctor {yesterday}.', promptAr: 'ذهب ملهم إلى الطبيب البارحة.', options: ['Where did Mulham go?', 'When did Mulham went to the doctor?', 'When did Mulham go to the doctor?', 'When Mulham went to the doctor?'], answer: 2, explainAr: 'نسأل عن الزمن (yesterday) بـ When، والفعل في الماضي فنستخدم did + الفعل المجرد go: When did Mulham go to the doctor?' },
      ],
    },
    {
      letter: 'E',
