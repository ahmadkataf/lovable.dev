  ...
  sections: [
    {
      ...
      questions: [
        { n: 1, kind: 'mcq', prompt: "Rasha and Rana are the writer's ___.", promptAr: 'رشا ورنا هما ___ الكاتب.', options: ['sisters', 'cousins', 'nieces', 'aunts'], answer: 1, explainAr: 'النص يبدأ بـ "My uncle has two daughters, Rasha and Rana" — بنتا العمّ هما ابنتا عمّ الكاتب، أي cousins.' },
        { n: 2, kind: 'mcq', prompt: 'Rana ___.', promptAr: 'رنا ___.', options: ['is quieter than her sister', 'always wears long skirts and cardigans', 'talks a lot and likes telling jokes', 'is taller than Rasha'], answer: 2, explainAr: 'النص: "Rana is a real chatterbox ... she loves telling jokes" أي أنها كثيرة الكلام وتحب النكات. أما الهدوء والتنانير والطول فهي صفات رشا.' },
        { n: 3, kind: 'mcq', prompt: 'What does "they" in the text refer to?', promptAr: 'إلامَ تعود كلمة "they" في النص؟', options: ['the twins', 'jeans and T-shirts', 'her friends', 'skirts and cardigans'], answer: 1, explainAr: 'الجملة: "Rana prefers jeans and T-shirts because she thinks they are more comfortable" — فالأشياء المريحة هي الجينز والقمصان القطنية.' },
        { n: 4, kind: 'mcq', prompt: '"Shy" is the opposite of:', promptAr: 'كلمة "Shy" (خجول) عكسها:', options: ['quiet', 'generous', 'confident', 'elegant'], answer: 2, explainAr: 'shy = خجول ومتوتر مع الآخرين، وعكسها confident = واثق من نفسه. أما quiet (هادئ) فقريبة من معناها وليست عكسها.' },
        { n: 5, kind: 'mcq', prompt: '"Generous" means ___.', promptAr: 'كلمة "Generous" تعني ___.', options: ['willing to give and share', 'graceful and stylish', 'very talkative', 'nervous and quiet'], answer: 0, explainAr: 'generous = كريم، أي مستعد للعطاء والمشاركة (willing to give and share)، والنص يؤكد ذلك: "They always share their things".' },
      ],
    },
    {
      letter: 'B',
    ...
    },
    {
      ...
      marks: 200,
      questions: [
        { n: 11, kind: 'mcq', topic: 'grammar', prompt: 'Basel is ___ than his brother Mouayyad.', promptAr: 'باسل ___ من أخيه مؤيّد.', options: ['tall', 'taller', 'the tallest', 'more tall'], answer: 1, explainAr: 'نقارن بين شخصين ومعنا than، فنستخدم صيغة المقارنة. tall صفة قصيرة (مقطع واحد) فنضيف -er: taller.' },
        { n: 12, kind: 'mcq', topic: 'grammar', prompt: 'This bag is ___ than that one.', promptAr: 'هذه الحقيبة ___ من تلك.', options: ['heavyer', 'more heavier', 'heavier', 'the heaviest'], answer: 2, explainAr: 'الصفة heavy تنتهي بـ y، فنقلب y إلى i ونضيف -er: heavier. ولا نجمع more مع -er.' },
        { n: 13, kind: 'mcq', topic: 'grammar', prompt: 'Lamar is ___ girl in our class.', promptAr: 'لمار ___ فتاة في صفّنا.', options: ['the most elegant', 'more elegant', 'the elegantest', 'most elegant'], answer: 0, explainAr: 'نقارن لمار بكل فتيات الصف (in our class) فنستخدم صيغة التفضيل. elegant صفة طويلة فنقول: the most elegant، ولا ننسى the.' },
        { n: 14, kind: 'mcq', topic: 'grammar', prompt: 'Yesterday was ___ day of my life. I lost my bag and missed the bus.', promptAr: 'كان البارحة ___ يوم في حياتي. أضعت حقيبتي وفاتتني الحافلة.', options: ['the worse', 'the baddest', 'worse', 'the worst'], answer: 3, explainAr: 'صيغة التفضيل (of my life) من الصفة الشاذة bad هي the worst. أما worse فهي صيغة المقارنة.' },
        { n: 15, kind: 'mcq', topic: 'grammar', prompt: "I don't have a new cardigan. I wish I ___ one.", promptAr: 'ليس لديّ كنزة صوفية جديدة. أتمنى لو ___ واحدة.', options: ['have', 'had', 'will have', 'am having'], answer: 1, explainAr: 'نتمنى عكس الواقع في الحاضر، فنستخدم wish + الماضي البسيط: I wish I had.' },
        { n: 16, kind: 'mcq', topic: 'grammar', prompt: 'Layan is short. She wishes she ___ taller.', promptAr: 'ليان قصيرة. تتمنى لو ___ أطول.', options: ['is', 'be', 'were', 'will be'], answer: 2, explainAr: 'بعد wish نستخدم الماضي، ومع فعل الكون نستخدم were لكل الأشخاص: She wishes she were taller.' },
        { n: 17, kind: 'mcq', topic: 'grammar', prompt: 'Bayan is a real chatterbox, ___?', promptAr: 'بيان ثرثارة حقاً، ___؟', options: ['is she', "isn't she", "doesn't she", "wasn't she"], answer: 1, explainAr: 'الجملة مثبتة فالذيل منفي، ونكرر الفعل المساعد نفسه (is) مع ضمير الفاعل (she): isn\'t she?' },
        { n: 18, kind: 'mcq', topic: 'grammar', prompt: 'Your cousins live in Hama, ___?', promptAr: 'أولاد عمّك يعيشون في حماة، ___؟', options: ["don't they", 'do they', "aren't they", "didn't they"], answer: 0, explainAr: 'لا يوجد فعل مساعد والفعل live مضارع بسيط، فنستخدم do، والجملة مثبتة فالذيل منفي: don\'t they?' },
        { n: 19, kind: 'mcq', topic: 'grammar', prompt: 'My uncle is ___ engineer.', promptAr: 'عمّي ___ مهندس.', options: ['a', 'an', 'the', 'no article'], answer: 1, explainAr: 'engineer تبدأ بصوت حرف علة (e)، فنستخدم an مع الاسم المفرد المعدود: an engineer.' },
        ...
        { n: 21, kind: 'mcq', topic: 'pronunciation', prompt: 'The word that has four syllables is:', promptAr: 'الكلمة التي تتكون من أربعة مقاطع صوتية هي:', options: ['beautiful', 'notebook', 'exhibition', 'generous'], answer: 2, explainAr: 'ex-hi-bi-tion = 4 مقاطع. أما beau-ti-ful و ge-ne-rous فثلاثة مقاطع، و note-book مقطعان.' },
        { n: 22, kind: 'mcq', topic: 'pronunciation', prompt: "The word that doesn't have /v/ sound is:", promptAr: 'الكلمة التي لا تحتوي على الصوت /v/ هي:', options: ['five', 'of', 'safe', 'save'], answer: 2, explainAr: 'safe تُلفظ بالصوت /f/. أما five و save ففيهما /v/، وكذلك of التي تُكتب بـ f لكنها تُلفظ /v/.' },
        ...
        { n: 24, kind: 'mcq', topic: 'grammar', prompt: 'We can see ___ moon at night.', promptAr: 'نستطيع أن نرى ___ قمر ليلاً.', options: ['a', 'an', 'the', 'no article'], answer: 2, explainAr: 'القمر شيء واحد لا يوجد غيره (مثل the sun و the world)، فنستخدم the: the moon.' },
        { n: 25, kind: 'mcq', topic: 'grammar', prompt: 'This old house ___ by my grandfather in 1950.', promptAr: 'هذا البيت القديم ___ على يد جدّي عام 1950.', options: ['built', 'was built', 'was building', 'is built'], answer: 1, explainAr: 'البيت لا يبني نفسه (by my grandfather) والحدث في الماضي (in 1950)، فنستخدم المبني للمجهول الماضي: was + التصريف الثالث: was built.' },
        { n: 26, kind: 'mcq', topic: 'wordform', prompt: 'Mouayyad was ___ when he heard the good news.', promptAr: 'كان مؤيّد ___ عندما سمع الخبر السار.', options: ['thrill', 'thrilling', 'thrilled', 'thrills'], answer: 2, explainAr: 'نصف شعور مؤيّد (هو المسرور جداً)، فنستخدم الصفة المنتهية بـ -ed: thrilled. أما thrilling فتصف الشيء المثير.' },
        { n: 27, kind: 'mcq', topic: 'vocab', prompt: 'The daughter of your brother or sister:', promptAr: 'ابنة أخيك أو أختك:', options: ['bride', 'niece', 'housewife', 'clerk'], answer: 1, explainAr: 'niece = ابنة الأخ أو ابنة الأخت (كلمة من الوحدة السابعة).' },
        { n: 28, kind: 'mcq', topic: 'vocab', prompt: 'A person who makes things from wood:', promptAr: 'شخص يصنع الأشياء من الخشب:', options: ['blacksmith', 'designer', 'pilot', 'carpenter'], answer: 3, explainAr: 'carpenter = النجّار. أما blacksmith فهو الحدّاد الذي يصنع الأشياء من الحديد (الوحدة السابعة).' },
        { n: 29, kind: 'mcq', topic: 'vocab', prompt: 'A problem that delays progress is called ___.', promptAr: 'المشكلة التي تؤخّر التقدّم تسمّى ___.', options: ['setback', 'passion', 'purpose', 'fulfillment'], answer: 0, explainAr: 'setback = عقبة أو انتكاسة تؤخّر التقدّم (كلمة من الوحدة العاشرة).' },
        { n: 30, kind: 'mcq', topic: 'vocab', prompt: 'The ability to read the minds of other people is known as ___.', promptAr: 'القدرة على قراءة أفكار الآخرين تُعرف بـ ___.', options: ['telekinesis', 'healing', 'telepathy', 'imagination'], answer: 2, explainAr: 'telepathy = التخاطر، أي قراءة أفكار الآخرين. أما telekinesis فهي تحريك الأشياء دون لمسها (الوحدة الحادية عشرة).' },
      ],
    },
    {
      letter: 'D',
      ...
      marks: 40,
      questions: [
        { n: 31, kind: 'ask', prompt: '{Doris} is taller than her sister.', promptAr: 'دوريس أطول من أختها.', options: ['What is taller than her sister?', 'Who is taller than her sister?', 'Who taller is than her sister?', 'Whose is taller than her sister?'], answer: 1, explainAr: 'نسأل عن شخص (Doris) هو الفاعل، فنستخدم Who مع ترتيب الجملة نفسه: Who is taller than her sister?' },
        { n: 32, kind: 'ask', prompt: 'The exhibition was held {last week}.', promptAr: 'أُقيم المعرض الأسبوع الماضي.', options: ['Where was the exhibition held?', 'When did the exhibition held?', 'When was the exhibition held?', 'When the exhibition was held?'], answer: 2, explainAr: 'نسأل عن الزمن (last week) فنستخدم When، والجملة مبنية للمجهول فنقدّم was على الفاعل: When was the exhibition held?' },
        { n: 33, kind: 'ask', prompt: 'My niece is {eight} years old.', promptAr: 'ابنة أختي عمرها ثماني سنوات.', options: ['How old is your niece?', 'How many is your niece?', 'How old your niece is?', 'How old does your niece?'], answer: 0, explainAr: 'نسأل عن العمر فنستخدم How old، ونقدّم is على الفاعل: How old is your niece?' },
        { n: 34, kind: 'ask', prompt: '{Yes, she tells a lot of jokes.}', promptAr: 'نعم، إنها تلقي الكثير من النكات.', options: ['Is she tell a lot of jokes?', 'What does she tell?', 'Did she tells a lot of jokes?', 'Does she tell a lot of jokes?'], answer: 3, explainAr: 'الجواب يبدأ بـ Yes فهو جواب سؤال نعم/لا. الفعل tells مضارع بسيط مع she، فنسأل بـ Does + الفعل المجرد: Does she tell a lot of jokes?' },
      ],
    },
    {
      letter: 'E',
