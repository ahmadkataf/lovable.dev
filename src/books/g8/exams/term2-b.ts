  ...
  sections: [
    {
      ...
      questions: [
        { n: 1, kind: 'mcq', prompt: 'Fashion shows are held in ___.', promptAr: 'تُقام عروض الأزياء في ___.', options: ["the writer's school", 'a big wooden box', 'big cities like Paris and Milan', 'small villages'], answer: 2, explainAr: 'النص: "fashion shows are held in big cities like Paris and Milan".' },
        { n: 2, kind: 'mcq', prompt: "The writer's grandmother thinks that ___.", promptAr: 'تعتقد جدّة الكاتب أن ___.', options: ['young people should follow famous designers', 'no clothes are more beautiful than traditional clothes', 'jeans are the most comfortable clothes', 'modern clothes are more beautiful than traditional ones'], answer: 1, explainAr: 'النص: "traditional clothes are the most beautiful clothes of all" — أي لا توجد ملابس أجمل من الملابس التقليدية، وهذا الخيار «no clothes are more beautiful than traditional clothes» بصياغة أخرى.' },
        { n: 3, kind: 'mcq', prompt: 'What does "they" in the text refer to?', promptAr: 'إلامَ تعود كلمة "they" في النص؟', options: ['new trends', 'famous designers', 'fashion shows', 'young people'], answer: 3, explainAr: 'الجملة: "Young people ... want to look up to date, so they follow famous designers" — الشباب هم الذين يتابعون المصمّمين، فكلمة they تعود على young people.' },
        { n: 4, kind: 'mcq', prompt: '"Confident" is the opposite of:', promptAr: 'كلمة "Confident" (واثق من نفسه) عكسها:', options: ['shy', 'fashionable', 'modern', 'happy'], answer: 0, explainAr: 'confident = واثق بنفسه، وعكسها shy (خجول، متوتّر وهادئ أمام الناس).' },
        { n: 5, kind: 'mcq', prompt: '"Influence" means ___.', promptAr: 'كلمة "Influence" تعني ___.', options: ['size', 'effect', 'charm', 'custom'], answer: 1, explainAr: 'influence = تأثير (effect). أما charm فمعنى glamour، و size معنى proportions، و custom معنى tradition.' },
      ],
    },
    {
      letter: 'B',
    ...
    },
    {
      ...
      marks: 200,
      questions: [
        { n: 11, kind: 'mcq', topic: 'grammar', prompt: 'Today is ___ than yesterday.', promptAr: 'اليوم ___ من البارحة.', options: ['more hot', 'hoter', 'hotter', 'hot'], answer: 2, explainAr: 'hot صفة قصيرة تنتهي بحرف علة واحد + حرف ساكن واحد، فنضاعف الحرف الأخير ونضيف -er: hotter.' },
        { n: 12, kind: 'mcq', topic: 'grammar', prompt: 'Friday is ___ day of the week for our family.', promptAr: 'يوم الجمعة هو ___ يوم في الأسبوع بالنسبة لعائلتنا.', options: ['the busiest', 'busiest', 'the busyest', 'busier than'], answer: 0, explainAr: 'نقارن الجمعة بكل أيام الأسبوع فنستخدم التفضيل مع the. والصفة تنتهي بـ y فتتحوّل إلى i ونضيف -est: the busiest.' },
        { n: 13, kind: 'mcq', topic: 'grammar', prompt: 'Layan is short. She wishes she ___ taller.', promptAr: 'ليان قصيرة. تتمنى لو كانت أطول.', options: ['will be', 'is', 'has', 'were'], answer: 3, explainAr: 'بعد wish نرجع خطوة إلى الماضي، ومع فعل الكون نستخدم were لكل الضمائر: She wishes she were taller.' },
        { n: 14, kind: 'mcq', topic: 'grammar', prompt: 'Mouayyad can swim well, ___?', promptAr: 'مؤيّد يستطيع السباحة جيداً، أليس كذلك؟', options: ["can't he", 'can he', "isn't he", "doesn't he"], answer: 0, explainAr: 'الجملة مثبتة بالفعل الناقص can فيكون السؤال الذيلي منفياً بالفعل نفسه: can\'t he.' },
        { n: 15, kind: 'mcq', topic: 'grammar', prompt: 'Mouayyad waited for ___ hour at the bus stop.', promptAr: 'انتظر مؤيّد ساعة عند موقف الحافلة.', options: ['(no article)', 'an', 'the', 'a'], answer: 1, explainAr: 'حرف h في hour صامت، فالكلمة تبدأ بصوت علة، والعبرة بالصوت لا بالحرف: an hour.' },
        { n: 16, kind: 'mcq', topic: 'grammar', prompt: 'The windows of our classroom ___ every morning.', promptAr: 'تُنظَّف نوافذ صفّنا كل صباح.', options: ['clean', 'are cleaning', 'are cleaned', 'is cleaned'], answer: 2, explainAr: 'النوافذ لا تنظّف نفسها فنستخدم المبني للمجهول في المضارع البسيط (every morning). والفاعل جمع (windows) فنقول are + التصريف الثالث: are cleaned.' },
        { n: 17, kind: 'mcq', topic: 'grammar', prompt: 'This cardigan is ___ than that one.', promptAr: 'هذه الكنزة ___ من تلك.', options: ['expensiver', 'the more expensive', 'most expensive', 'more expensive'], answer: 3, explainAr: 'نقارن بين شيئين (than) والصفة طويلة (expensive) فنستخدم more + الصفة: more expensive.' },
        { n: 18, kind: 'mcq', topic: 'grammar', prompt: 'My brother always plays loud music. I wish he ___ stop.', promptAr: 'أخي يشغّل الموسيقى بصوت عالٍ دائماً. أتمنى لو يتوقّف.', options: ['is', 'does', 'will', 'would'], answer: 3, explainAr: 'عندما نتمنى أن يغيّر شخص آخر تصرّفه نستخدم wish + would: I wish he would stop.' },
        { n: 19, kind: 'mcq', topic: 'grammar', prompt: 'Bayan lived in Hama, ___?', promptAr: 'عاشت بيان في حماة، أليس كذلك؟', options: ["doesn't she", 'did she', "didn't she", "wasn't she"], answer: 2, explainAr: 'لا يوجد فعل مساعد والفعل lived في الماضي البسيط، فنستخدم did، ولأن الجملة مثبتة يكون السؤال منفياً: didn\'t she.' },
        { n: 20, kind: 'mcq', topic: 'grammar', prompt: "This mystery can't ___ easily.", promptAr: 'لا يمكن تفسير هذا اللغز بسهولة.', options: ['explain', 'be explained', 'be explaining', 'explained'], answer: 1, explainAr: 'اللغز لا يفسّر نفسه فنحتاج المبني للمجهول. مع الأفعال الناقصة: can/can\'t + be + التصريف الثالث: can\'t be explained.' },
        { n: 21, kind: 'mcq', topic: 'pronunciation', prompt: 'The word that has four syllables is:', promptAr: 'الكلمة المؤلفة من أربعة مقاطع صوتية هي:', options: ['fashionable', 'bride', 'confident', 'designer'], answer: 0, explainAr: 'fash-ion-a-ble أربعة مقاطع. أما de-sign-er و con-fi-dent فثلاثة مقاطع، و bride مقطع واحد.' },
        { n: 22, kind: 'mcq', topic: 'pronunciation', prompt: 'The word that has /f/ sound is:', promptAr: 'الكلمة التي فيها الصوت /f/ هي:', options: ['save', 'of', 'vet', 'proof'], answer: 3, explainAr: 'proof تنتهي بالصوت /f/. أما vet و save ففيهما /v/، وكلمة of تُلفظ أيضاً /v/ مع أنها تُكتب بحرف f.' },
        { n: 23, kind: 'mcq', topic: 'pronunciation', prompt: "The word that doesn't have /ʃ/ sound is:", promptAr: 'الكلمة التي لا تحتوي على الصوت /ʃ/ (ش) هي:', options: ['cheese', 'pressure', 'shy', 'sure'], answer: 0, explainAr: 'ch في cheese تُلفظ /tʃ/ (تش). أما sh في shy، و s في sure و ss في pressure فتُلفظ كلها /ʃ/ (ش).' },
        { n: 24, kind: 'mcq', topic: 'grammar', prompt: 'This is ___ film I have ever seen.', promptAr: 'هذا ___ فيلم رأيته في حياتي.', options: ['the baddest', 'the worst', 'worst', 'the worse'], answer: 1, explainAr: 'bad صفة شاذة: bad → worse → the worst. ونقارن الفيلم بكل الأفلام التي رأيتها فنستخدم التفضيل مع the: the worst.' },
        { n: 25, kind: 'mcq', topic: 'grammar', prompt: 'We usually have ___ breakfast at seven o\'clock.', promptAr: 'نتناول عادةً الفطور في الساعة السابعة.', options: ['a', 'an', '(no article)', 'the'], answer: 2, explainAr: 'لا نستخدم أداة تعريف أو تنكير قبل أسماء الوجبات (breakfast, lunch, dinner): have breakfast.' },
        { n: 26, kind: 'mcq', topic: 'wordform', prompt: 'Passing the exam with full marks was a great ___ for Layan.', promptAr: 'كان النجاح في الامتحان بالعلامة الكاملة إنجازاً عظيماً لليان.', options: ['achieved', 'achievement', 'achieving', 'achieve'], answer: 1, explainAr: 'بعد الصفة great وأداة التنكير a نحتاج اسماً: achievement (إنجاز). أما achieve فهو الفعل.' },
        { n: 27, kind: 'mcq', topic: 'vocab', prompt: 'An excessively talkative person:', promptAr: 'شخص يتكلّم كثيراً جداً:', options: ['pioneer', 'clerk', 'chatterbox', 'carpenter'], answer: 2, explainAr: 'chatterbox = ثرثار، كثير الكلام (كلمة من الوحدة السابعة).' },
        { n: 28, kind: 'mcq', topic: 'vocab', prompt: 'In or to a foreign country:', promptAr: 'في بلد أجنبي أو إليه:', options: ['western', 'invisible', 'external', 'abroad'], answer: 3, explainAr: 'abroad = في الخارج، خارج البلد (كلمة من الوحدتين الثامنة والعاشرة).' },
        { n: 29, kind: 'mcq', topic: 'vocab', prompt: 'The people watching a show are called the ___.', promptAr: 'الناس الذين يشاهدون عرضاً يُسمّون ___.', options: ['audience', 'generation', 'designer', 'researcher'], answer: 0, explainAr: 'audience = الجمهور (كلمة من الوحدة الحادية عشرة).' },
        { n: 30, kind: 'mcq', topic: 'vocab', prompt: 'A creature from outer space:', promptAr: 'مخلوق من الفضاء الخارجي:', options: ['alien', 'pelican', 'ghost', 'pilot'], answer: 0, explainAr: 'alien = كائن فضائي (كلمة من الوحدة الثانية عشرة). أما ghost فهو الشبح، و pelican طائر البجع.' },
      ],
    },
    {
      letter: 'D',
      ...
      marks: 40,
      questions: [
        { n: 31, kind: 'ask', prompt: 'Fashion shows are held {in Paris}.', promptAr: 'تُقام عروض الأزياء في باريس.', options: ['Where fashion shows are held?', 'When are fashion shows held?', 'Where are fashion shows held?', 'Where do fashion shows held?'], answer: 2, explainAr: 'نسأل عن المكان (in Paris) بـ Where، والجملة مبنية للمجهول بـ are فنقدّمها على الفاعل: Where are fashion shows held?' },
        { n: 32, kind: 'ask', prompt: '{The illusionist} made the ball invisible.', promptAr: 'جعل المخادع البصري الكرة تختفي.', options: ['What made the ball invisible?', 'Who made the ball invisible?', 'Who the ball made invisible?', 'Who did made the ball invisible?'], answer: 1, explainAr: 'نسأل عن شخص في موقع الفاعل بـ Who، ويبقى الفعل made كما هو دون did: Who made the ball invisible?' },
        { n: 33, kind: 'ask', prompt: 'Lamar wears a uniform {because she is a nurse}.', promptAr: 'ترتدي لمار زيّاً موحّداً لأنها ممرّضة.', options: ['Why is Lamar wear a uniform?', 'Why Lamar wears a uniform?', 'What does Lamar wear?', 'Why does Lamar wear a uniform?'], answer: 3, explainAr: 'نسأل عن السبب (because ...) بـ Why، والفعل مضارع بسيط مع she فنستخدم does + الفعل المجرد: Why does Lamar wear a uniform?' },
        { n: 34, kind: 'ask', prompt: 'Mouayyad bought {two} cardigans.', promptAr: 'اشترى مؤيّد كنزتين.', options: ['How many cardigans Mouayyad bought?', 'How many cardigans did Mouayyad bought?', 'How much cardigans did Mouayyad buy?', 'How many cardigans did Mouayyad buy?'], answer: 3, explainAr: 'نسأل عن عدد شيء معدود (cardigans) بـ How many، والفعل في الماضي فنستخدم did + الفعل المجرد buy: How many cardigans did Mouayyad buy?' },
      ],
    },
    {
      letter: 'E',
