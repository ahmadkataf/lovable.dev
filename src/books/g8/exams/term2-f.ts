  ...
  sections: [
    {
      ...
      questions: [
        { n: 1, kind: 'mcq', prompt: 'Traditional clothes are passed ___.', promptAr: 'تنتقل الملابس التقليدية ___.', options: ['from designers to shops', 'from one generation to the next', 'from one country to another', 'from the internet to TV'], answer: 1, explainAr: 'النص: "Traditional clothes are passed from one generation to the next" — من جيل إلى الجيل الذي يليه.' },
        { n: 2, kind: 'mcq', prompt: 'Many young designers today ___.', promptAr: 'كثير من المصمّمين الشباب اليوم ___.', options: ['forget their own traditions', 'never hold fashion shows', 'mix traditional clothes with modern fashion', 'only make western clothes'], answer: 2, explainAr: 'النص: "many young designers today mix the old and the new. They add a modern twist to traditional clothes" أي يمزجون التقليدي بالحديث.' },
        { n: 3, kind: 'mcq', prompt: 'What does "their" in the text refer to?', promptAr: 'إلامَ تعود كلمة "their" في النص؟', options: ['young designers', 'modern dresses', 'traditions', 'people who go abroad'], answer: 0, explainAr: 'الجملة: "they make modern dresses with their grandmothers\' traditional designs" — و they هنا تعود على young designers، فجدّاتهم هنّ جدّات المصمّمين الشباب.' },
        { n: 4, kind: 'mcq', prompt: '"Fashionable" is the opposite of:', promptAr: 'كلمة "Fashionable" (عصري/مواكب للموضة) عكسها:', options: ['stylish', 'confident', 'up to date', 'old-fashioned'], answer: 3, explainAr: 'fashionable = يتبع الموضة الحالية، وعكسها old-fashioned = قديم الطراز. أما up to date و stylish فمعناهما قريب منها.' },
        { n: 5, kind: 'mcq', prompt: '"Adopt" means ___.', promptAr: 'كلمة "Adopt" تعني ___.', options: ['to change', 'to depend on', 'to take and use as your own', 'to make someone admire you'], answer: 2, explainAr: 'adopt = يتبنّى، أي يأخذ الشيء ويستخدمه كأنه له. أما الخيارات الأخرى فهي معاني rely on و alter و impress.' },
      ],
    },
    {
      letter: 'B',
    ...
    },
    {
      ...
      marks: 200,
      questions: [
        { n: 11, kind: 'mcq', topic: 'grammar', prompt: 'Our new house is ___ than the old one.', promptAr: 'بيتنا الجديد ___ من القديم.', options: ['more large', 'larger', 'the largest', 'largger'], answer: 1, explainAr: 'نقارن بين بيتين ومعنا than. large تنتهي بـ e فنضيف -r فقط: larger.' },
        { n: 12, kind: 'mcq', topic: 'grammar', prompt: 'Layan is ___ than her friends. She always makes them laugh.', promptAr: 'ليان ___ من صديقاتها. إنها تضحكهن دائماً.', options: ['funnier', 'the funniest', 'more funny', 'funnyer'], answer: 0, explainAr: 'funny تنتهي بـ y، فنقلب y إلى i ونضيف -er: funnier (مع than).' },
        { n: 13, kind: 'mcq', topic: 'grammar', prompt: 'These are ___ shoes I have.', promptAr: 'هذا ___ حذاء أملكه.', options: ['the comfortablest', 'most comfortable', 'more comfortable', 'the most comfortable'], answer: 3, explainAr: 'نقارن هذا الحذاء بكل أحذيتي فنستخدم التفضيل، و comfortable صفة طويلة: the most comfortable.' },
        { n: 14, kind: 'mcq', topic: 'grammar', prompt: 'Basel is ___ player in our football team.', promptAr: 'باسل ___ لاعب في فريق كرة القدم لدينا.', options: ['the best', 'the better', 'better', 'the goodest'], answer: 0, explainAr: 'good صفة شاذة، وصيغة التفضيل منها the best (نقارن باسل بكل لاعبي الفريق).' },
        { n: 15, kind: 'mcq', topic: 'grammar', prompt: 'My sister always takes my things. I wish she ___ ask me first.', promptAr: 'أختي تأخذ أشيائي دائماً. أتمنى لو ___ تستأذنني أولاً.', options: ['is', 'would', 'will', 'does'], answer: 1, explainAr: 'نتمنى أن يغيّر شخص آخر تصرّفه فنستخدم wish + would + الفعل المجرد: I wish she would ask.' },
        { n: 16, kind: 'mcq', topic: 'grammar', prompt: 'I live far from my school. I wish I ___ near it.', promptAr: 'أسكن بعيداً عن مدرستي. أتمنى لو ___ قريباً منها.', options: ['will live', 'am living', 'lived', 'live'], answer: 2, explainAr: 'نتمنى عكس الواقع الحاضر فنستخدم wish + الماضي البسيط: I wish I lived.' },
        { n: 17, kind: 'mcq', topic: 'grammar', prompt: 'Your father has got a new car, ___?', promptAr: 'أبوك لديه سيارة جديدة، ___؟', options: ["isn't he", 'has he', "doesn't he", "hasn't he"], answer: 3, explainAr: 'الفعل المساعد في الجملة has، والجملة مثبتة فالذيل منفي، والفاعل father فالضمير he: hasn\'t he?' },
        { n: 18, kind: 'mcq', topic: 'grammar', prompt: 'I am late, ___?', promptAr: 'لقد تأخّرت، ___؟', options: ["isn't I", "aren't I", "don't I", 'am not I'], answer: 1, explainAr: 'حالة خاصة: ذيل I am المثبتة هو aren\'t I.' },
        { n: 19, kind: 'mcq', topic: 'grammar', prompt: 'Mouayyad waited for ___ hour at the bus station.', promptAr: 'انتظر مؤيّد ___ ساعة في محطة الحافلات.', options: ['a', 'no article', 'the', 'an'], answer: 3, explainAr: 'حرف h في hour صامت، فالكلمة تبدأ بصوت حرف علة، لذلك نستخدم an: an hour.' },
        { n: 20, kind: 'mcq', topic: 'grammar', prompt: 'Science-fiction movies ___ by millions of people every year.', promptAr: 'أفلام الخيال العلمي ___ من قِبَل ملايين الناس كل عام.', options: ['are watched', 'are watching', 'watch', 'is watched'], answer: 0, explainAr: 'الأفلام لا تشاهِد بل تُشاهَد (by millions of people)، وهي حقيقة متكررة (every year) والفاعل جمع: are + التصريف الثالث: are watched.' },
        { n: 21, kind: 'mcq', topic: 'pronunciation', prompt: 'The word "generation" has ___ syllables.', promptAr: 'كلمة "generation" تتكون من ___ مقاطع صوتية.', options: ['five', 'three', 'four', 'two'], answer: 2, explainAr: 'ge-ne-ra-tion = أربعة مقاطع، لكل مقطع صوت حرف علة واحد.' },
        { n: 22, kind: 'mcq', topic: 'pronunciation', prompt: "The word that doesn't have /ʃ/ sound is:", promptAr: 'الكلمة التي لا تحتوي على الصوت /ʃ/ هي:', options: ['chin', 'pressure', 'shy', 'insurance'], answer: 0, explainAr: 'ch في chin تُلفظ /tʃ/ (تش). أما shy ففيها sh /ʃ/، و pressure و insurance يُلفظ فيهما s بصوت /ʃ/.' },
        { n: 23, kind: 'mcq', topic: 'pronunciation', prompt: 'The word that has /f/ sound is:', promptAr: 'الكلمة التي تحتوي على الصوت /f/ هي:', options: ['vine', 'vet', 'proof', 'of'], answer: 2, explainAr: 'proof تُلفظ بـ /f/. أما vet و vine ففيهما /v/، و of تُكتب بـ f لكنها تُلفظ /v/.' },
        { n: 24, kind: 'mcq', topic: 'grammar', prompt: 'My cousin speaks ___ English very well.', promptAr: 'ابن عمّي يتكلم ___ الإنجليزية جيداً جداً.', options: ['an', 'the', 'a', 'no article'], answer: 3, explainAr: 'لا نستخدم أداة قبل أسماء اللغات: speak English.' },
        ...
        { n: 26, kind: 'mcq', topic: 'wordform', prompt: 'UFOs are still a ___ phenomenon for many people.', promptAr: 'ما تزال الأجسام الطائرة المجهولة ظاهرة ___ لكثير من الناس.', options: ['mysteriously', 'mysteries', 'mysterious', 'mystery'], answer: 2, explainAr: 'قبل الاسم (phenomenon) نحتاج صفة: mysterious (غامضة). أما mystery فاسم، و mysteriously حال.' },
        { n: 27, kind: 'mcq', topic: 'vocab', prompt: 'Not recognised; not known what it is:', promptAr: 'غير معروف؛ لا يُعرف ما هو:', options: ['unidentified', 'logical', 'supernatural', 'emotional'], answer: 0, explainAr: 'unidentified = مجهول الهوية، ومنها UFO = unidentified flying object (الوحدة الثانية عشرة).' },
        { n: 28, kind: 'mcq', topic: 'vocab', prompt: 'An excessively talkative person:', promptAr: 'شخص كثير الكلام جداً:', options: ['designer', 'swimmer', 'illusionist', 'chatterbox'], answer: 3, explainAr: 'chatterbox = ثرثار، كثير الكلام (الوحدة السابعة).' },
        { n: 29, kind: 'mcq', topic: 'vocab', prompt: 'Something you hope to achieve; an aim is called ___.', promptAr: 'الشيء الذي تأمل أن تحقّقه، أي الغاية، يسمّى ___.', options: ['setback', 'goal', 'excuse', 'obstacle'], answer: 1, explainAr: 'goal = هدف (الوحدة التاسعة). أما obstacle و setback فهما عقبتان في طريق الهدف.' },
        { n: 30, kind: 'mcq', topic: 'vocab', prompt: 'The amount of water in the air is known as ___.', promptAr: 'كمية الماء الموجودة في الهواء تُعرف بـ ___.', options: ['phenomenon', 'lightning', 'surface', 'humidity'], answer: 3, explainAr: 'humidity = الرطوبة، أي كمية بخار الماء في الهواء (الوحدة الثانية عشرة).' },
      ],
    },
    {
      letter: 'D',
      ...
      marks: 40,
      questions: [
        { n: 31, kind: 'ask', prompt: '{The designer} made this beautiful dress.', promptAr: 'صنع المصمّم هذا الفستان الجميل.', options: ['Who did this beautiful dress make?', 'Who made this beautiful dress?', 'What did the designer make?', 'Whom made this beautiful dress?'], answer: 1, explainAr: 'نسأل عن الفاعل (شخص) فنستخدم Who مباشرة مع الفعل الماضي دون did: Who made this beautiful dress?' },
        { n: 32, kind: 'ask', prompt: 'Fashion shows are held {in big cities}.', promptAr: 'تُقام عروض الأزياء في المدن الكبيرة.', options: ['Where are fashion shows held?', 'Where do fashion shows held?', 'Where fashion shows are held?', 'When are fashion shows held?'], answer: 0, explainAr: 'نسأل عن المكان فنستخدم Where، والجملة مبنية للمجهول فنقدّم are على الفاعل: Where are fashion shows held?' },
        { n: 33, kind: 'ask', prompt: 'Rama wants to be a painter {because she loves colours}.', promptAr: 'تريد راما أن تكون رسّامة لأنها تحب الألوان.', options: ['What does Rama want to be?', 'Why does Rama wants to be a painter?', 'Why does Rama want to be a painter?', 'Why Rama wants to be a painter?'], answer: 2, explainAr: 'نسأل عن السبب فنستخدم Why، والفعل wants مضارع مع she فنستخدم does + الفعل المجرد: Why does Rama want to be a painter?' },
        { n: 34, kind: 'ask', prompt: "{No, they didn't see a UFO.}", promptAr: 'لا، لم يروا جسماً طائراً مجهولاً.', options: ['What did they see?', 'Did they see a UFO?', "Didn't they saw a UFO?", 'Do they see a UFO?'], answer: 1, explainAr: 'الجواب يبدأ بـ No فهو جواب سؤال نعم/لا، والفعل ماضٍ (didn\'t see) فنسأل بـ Did + الفعل المجرد: Did they see a UFO?' },
      ],
    },
    {
      letter: 'E',
