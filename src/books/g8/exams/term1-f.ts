  ...
  sections: [
    {
      ...
      questions: [
        { n: 1, kind: 'mcq', prompt: 'Rasha learned to make soap from her ___.', promptAr: 'تعلّمت رشا صنع الصابون من ___.', options: ['neighbours', 'teachers', 'mother', 'grandmother'], answer: 3, explainAr: 'النص: "she loved making soap with her grandmother. Her grandmother used a traditional method" — تعلّمته من جدّتها.' },
        { n: 2, kind: 'mcq', prompt: 'Rasha started her business ___.', promptAr: 'بدأت رشا عملها ___.', options: ['with little money and simple help from her family', 'before she graduated from university', 'with a lot of money from a bank', 'in a big factory in another city'], answer: 0, explainAr: 'النص: "She didn\'t have much money ... With humble help from her family" — بمال قليل ومساعدة بسيطة من عائلتها. والخيار «before she graduated from university» خاطئ لأنها بدأت بعد التخرّج (After she graduated).' },
        ...
        { n: 4, kind: 'mcq', prompt: '"Risk" is the opposite of:', promptAr: 'كلمة "Risk" (مخاطرة) عكسها:', options: ['advice', 'danger', 'safety', 'dream'], answer: 2, explainAr: 'risk = احتمال حدوث شيء سيّئ (مخاطرة)، وعكسها safety = الأمان والسلامة من الخطر. أما danger فمعناها قريب من risk لا عكسها.' },
        { n: 5, kind: 'mcq', prompt: '"Founder" means ___.', promptAr: 'كلمة "Founder" تعني ___.', options: ['a person who starts a company', 'a person who gives advice', 'a person who works in a factory', 'a person who buys goods'], answer: 0, explainAr: 'founder = مؤسِّس، أي الشخص الذي يبدأ شركة أو مؤسسة. أما a person who buys goods فهو customer.' },
      ],
    },
    {
      letter: 'B',
    ...
    },
    {
      ...
      marks: 200,
      questions: [
        { n: 11, kind: 'mcq', topic: 'tense', prompt: 'My mother ___ dinner at the moment.', promptAr: 'أمي ___ العشاء في هذه اللحظة.', options: ['cooked', 'is cooking', 'was cooking', 'cooks'], answer: 1, explainAr: 'at the moment تدلّ على حدث يجري الآن، فنستخدم المضارع المستمر: is cooking.' },
        { n: 12, kind: 'mcq', topic: 'tense', prompt: 'The sun ___ in the east.', promptAr: 'الشمس ___ من الشرق.', options: ['is rising', 'rose', 'rise', 'rises'], answer: 3, explainAr: 'حقيقة ثابتة فنستخدم المضارع البسيط، ومع The sun (مفرد) نضيف s: rises.' },
        { n: 13, kind: 'mcq', topic: 'tense', prompt: '"The phone is ringing." "OK, I ___ it."', promptAr: '"الهاتف يرنّ." "حسناً، ___ عليه."', options: ['answered', 'am going to answer', 'will answer', 'answer'], answer: 2, explainAr: 'قرار نتّخذه في لحظة الكلام (لم نخطّط له من قبل)، فنستخدم will: will answer.' },
        { n: 14, kind: 'mcq', topic: 'tense', prompt: 'Bayan ___ to Damascus two years ago.', promptAr: 'بيان ___ إلى دمشق قبل سنتين.', options: ['moved', 'is moving', 'moves', 'has moved'], answer: 0, explainAr: 'two years ago تدلّ على حدث انتهى في الماضي، فنستخدم الماضي البسيط: moved.' },
        { n: 15, kind: 'mcq', topic: 'tense', prompt: 'At eight o\'clock last night, we ___ TV.', promptAr: 'في الساعة الثامنة من مساء أمس ___ التلفاز.', options: ['are watching', 'watch', 'were watching', 'have watched'], answer: 2, explainAr: 'حدث كان مستمراً في لحظة معيّنة من الماضي (at eight o\'clock last night)، فنستخدم الماضي المستمر: were watching.' },
        { n: 16, kind: 'mcq', topic: 'tense', prompt: 'Mouayyad ___ to France twice.', promptAr: 'مؤيّد ___ إلى فرنسا مرتين.', options: ['was being', 'has been', 'is going', 'have been'], answer: 1, explainAr: 'المضارع التام للتجارب حتى الآن (twice): has + التصريف الثالث، ومع المفرد نستخدم has: has been.' },
        { n: 17, kind: 'mcq', topic: 'reported', prompt: '"I can swim very well." Basel said that ___.', promptAr: '"أستطيع أن أسبح جيداً جداً." قال باسل إنه ___.', options: ['he could swam very well', 'I can swim very well', 'he can swam very well', 'he could swim very well'], answer: 3, explainAr: 'في الكلام المنقول: I ← he، و can ← could، ويبقى الفعل بعد could مجرّداً: he could swim.' },
        ...
        { n: 19, kind: 'mcq', topic: 'tense', prompt: 'Lamar was hungry because she ___ breakfast.', promptAr: 'كانت لمار جائعة لأنها ___ الفطور.', options: ["doesn't have", "won't have", "hadn't had", "hasn't had"], answer: 2, explainAr: 'عدم تناول الفطور حدث قبل أن تجوع في الماضي، فنستخدم الماضي التام المنفي: hadn\'t + التصريف الثالث: hadn\'t had.' },
        { n: 20, kind: 'mcq', topic: 'conditional', prompt: 'If Rami ___ harder, he would get better marks.', promptAr: 'لو ___ رامي بجدّ أكبر لحصل على علامات أفضل.', options: ['will study', 'would study', 'studies', 'studied'], answer: 3, explainAr: 'الشرط الثاني: If + الماضي البسيط، ثم would + الفعل. لذلك: If Rami studied.' },
        { n: 21, kind: 'mcq', topic: 'conditional', prompt: 'What ___ you do if you saw a bully at school?', promptAr: 'ماذا ___ لو رأيت متنمّراً في المدرسة؟', options: ['would', 'did', 'do', 'will'], answer: 0, explainAr: 'سؤال الشرط الثاني: What would you do if + ماضٍ بسيط (saw)؟ فنستخدم would.' },
        { n: 22, kind: 'mcq', topic: 'grammar', prompt: '___ is this souvenir? — It\'s 500 pounds.', promptAr: '___ هذا التذكار؟ — إنه بـ 500 ليرة.', options: ['What', 'Which', 'How many', 'How much'], answer: 3, explainAr: 'نسأل عن السعر بـ How much. أما How many فنستخدمها للعدد مع الأسماء المعدودة بالجمع.' },
        { n: 23, kind: 'mcq', topic: 'pronunciation', prompt: 'The word that has silent "gh" is:', promptAr: 'الكلمة التي فيها "gh" صامتة هي:', options: ['straight', 'laugh', 'enough', 'ghost'], answer: 0, explainAr: 'في straight لا تُلفظ gh. أما في enough و laugh فتُلفظ gh مثل f، وفي ghost يُلفظ g.' },
        { n: 24, kind: 'mcq', topic: 'pronunciation', prompt: 'The word that doesn\'t have /k/ sound is:', promptAr: 'الكلمة التي لا تحتوي على الصوت /k/ هي:', options: ['duck', 'cake', 'cinema', 'cloud'], answer: 2, explainAr: 'في cinema يأتي بعد c الحرف i فيُلفظ /s/. أما cake و cloud ففيها c = /k/، و duck فيها ck = /k/.' },
        ...
        { n: 26, kind: 'mcq', topic: 'wordform', prompt: 'The goalkeeper played ___ in the final match.', promptAr: 'لعب حارس المرمى ___ في المباراة النهائية.', options: ['more brilliant', 'brilliance', 'brilliantly', 'brilliant'], answer: 2, explainAr: 'نحتاج ظرفاً يصف الفعل played (كيف لعب؟)، والظرف يُصاغ بإضافة -ly إلى الصفة: brilliantly.' },
        { n: 27, kind: 'mcq', topic: 'vocab', prompt: 'The place you are travelling to:', promptAr: 'المكان الذي تسافر إليه:', options: ['arrival', 'destination', 'journey', 'passport'], answer: 1, explainAr: 'destination = وجهة السفر، المكان الذي نسافر إليه (كلمة من الوحدة الثالثة).' },
        { n: 28, kind: 'mcq', topic: 'vocab', prompt: 'To say that you will not do something:', promptAr: 'أن تقول إنك لن تفعل شيئاً ما:', options: ['allow', 'accept', 'confirm', 'refuse'], answer: 3, explainAr: 'refuse = يرفض، أي يقول إنه لن يفعل الشيء (كلمة من الوحدة الثانية).' },
        { n: 29, kind: 'mcq', topic: 'vocab', prompt: 'A person who buys goods or services is called ___.', promptAr: 'الشخص الذي يشتري البضائع أو الخدمات يسمّى ___.', options: ['customer', 'supervisor', 'founder', 'expert'], answer: 0, explainAr: 'customer = زبون، الشخص الذي يشتري البضائع أو الخدمات (كلمة من الوحدة السادسة).' },
        { n: 30, kind: 'mcq', topic: 'vocab', prompt: 'Very important:', promptAr: 'مهمّ جداً:', options: ['flexible', 'cheap', 'humble', 'major'], answer: 3, explainAr: 'major = رئيسي / كبير الأهمية، أي مهمّ جداً (كلمة من الوحدة الأولى).' },
      ],
    },
    {
      letter: 'D',
      ...
      marks: 40,
      questions: [
        { n: 31, kind: 'ask', prompt: 'Lamar stayed at home {because she was ill}.', promptAr: 'بقيت لمار في البيت لأنها كانت مريضة.', options: ['Why did Lamar stay at home?', 'Why did Lamar stayed at home?', 'Why Lamar stayed at home?', 'When did Lamar stay at home?'], answer: 0, explainAr: 'نسأل عن السبب (because) بـ Why، والجملة في الماضي فنستخدم did + الفاعل + الفعل المجرّد: Why did Lamar stay at home?' },
        { n: 32, kind: 'ask', prompt: '{Yes, I have been to Palmyra.}', promptAr: 'نعم، لقد زرت تدمر.', options: ['Did you have been to Palmyra?', 'Have you been to Palmyra?', 'Has you been to Palmyra?', 'Where have you been?'], answer: 1, explainAr: 'الجواب يبدأ بـ Yes فهو جواب سؤال بنعم/لا. الفعل مضارع تام (have been) فنقدّم have على الفاعل you: Have you been to Palmyra?' },
        { n: 33, kind: 'ask', prompt: 'The children are playing {in the garden}.', promptAr: 'الأطفال يلعبون في الحديقة.', options: ['What are the children playing?', 'Where the children are playing?', 'Where are the children playing?', 'Where do the children playing?'], answer: 2, explainAr: 'نسأل عن المكان بـ Where، والفعل مضارع مستمر فنقدّم are على الفاعل: Where are the children playing?' },
        { n: 34, kind: 'ask', prompt: '{Mr. Kamal} teaches us English.', promptAr: 'الأستاذ كمال يدرّسنا الإنجليزية.', options: ['Who teaches you English?', 'Who do you teach English?', 'What teaches you English?', 'Who does teach you English?'], answer: 0, explainAr: 'نسأل عن الفاعل (شخص) بـ Who، وعندما تكون Who هي الفاعل لا نستخدم does ويبقى الفعل مع s: Who teaches you English?' },
      ],
    },
    {
      letter: 'E',
