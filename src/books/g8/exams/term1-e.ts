  ...
  sections: [
    {
      ...
      questions: [
        { n: 1, kind: 'mcq', prompt: 'Sixty years ago, pupils relied on ___ for their knowledge.', promptAr: 'قبل ستين عاماً كان التلاميذ يعتمدون على ___ في معارفهم.', options: ['computers', 'the Internet', 'virtual reality', 'their teachers'], answer: 3, explainAr: 'النص: "There were no computers, so pupils relied on their teachers for all their knowledge" — لم تكن هناك حواسيب فاعتمدوا على معلّميهم.' },
        { n: 2, kind: 'mcq', prompt: 'According to the writer, ___.', promptAr: 'بحسب الكاتب، ___.', options: ['good teachers will always be important, even with modern technology', 'computers will completely replace teachers in the future', 'students now learn everything from books', 'robotic teachers are teaching in his school now'], answer: 0, explainAr: 'الكاتب يقول: "I don\'t think computers will ever replace good teachers completely" وإن أفضل مدرسة ستجمع بين الابتكارات والمعلمين الأكفاء، أي أن المعلم الجيد سيبقى مهماً. الخيار «computers will completely replace teachers in the future» عكس رأيه، و «students now learn everything from books» كان في الماضي، و «robotic teachers are teaching in his school now» مجرّد توقّع للمستقبل.' },
        { n: 3, kind: 'mcq', prompt: 'What does "who" in the text refer to?', promptAr: 'إلامَ تعود كلمة "who" في النص؟', options: ['a computer', 'students', 'a teacher', 'information'], answer: 2, explainAr: 'الجملة: "a teacher who really cares about students"، فكلمة who تعود على a teacher (المعلّم). وwho تُستخدم للأشخاص لا للأشياء مثل a computer.' },
        { n: 4, kind: 'mcq', prompt: '"Traditional" is the opposite of:', promptAr: 'كلمة "Traditional" (تقليدي) عكسها:', options: ['effective', 'modern', 'practical', 'major'], answer: 1, explainAr: 'traditional = تقليدي يتبع الطرق القديمة، وعكسها modern = حديث. والنص نفسه يقابل بين طرق الماضي التقليدية والتكنولوجيا الحديثة.' },
        { n: 5, kind: 'mcq', prompt: '"Provide" means ___.', promptAr: 'كلمة "Provide" تعني ___.', options: ['to give something to be used', 'to depend on', 'to make something better', 'to put two things together'], answer: 0, explainAr: 'provide = يزوّد / يوفّر، أي يعطي شيئاً ليُستخدم. أما to depend on فهي معنى rely، و to put two things together معنى combine، و to make something better معنى improve.' },
      ],
    },
    {
      letter: 'B',
    ...
    },
    {
      ...
      marks: 200,
      questions: [
        { n: 11, kind: 'mcq', topic: 'tense', prompt: 'Listen! Somebody ___ at the door.', promptAr: 'اسمع! أحدهم ___ الباب.', options: ['will knock', 'knocked', 'knocks', 'is knocking'], answer: 3, explainAr: 'Listen! تدلّ على حدث يجري الآن فنستخدم المضارع المستمر: is knocking.' },
        { n: 12, kind: 'mcq', topic: 'tense', prompt: 'Hala usually ___ to school by bus.', promptAr: 'تذهب هالة عادةً ___ إلى المدرسة بالحافلة.', options: ['go', 'is going', 'goes', 'went'], answer: 2, explainAr: 'usually تدلّ على عادة فنستخدم المضارع البسيط، ومع Hala (هي) نضيف es: goes.' },
        { n: 13, kind: 'mcq', topic: 'tense', prompt: 'Basel has bought the tickets. He ___ his relatives in Aleppo next week.', promptAr: 'اشترى باسل التذاكر. ___ أقاربه في حلب الأسبوع القادم.', options: ['visited', 'is going to visit', 'visits', 'was visiting'], answer: 1, explainAr: 'خطة قرّرها مسبقاً (اشترى التذاكر) للمستقبل (next week) فنستخدم be going to: is going to visit.' },
        { n: 14, kind: 'mcq', topic: 'tense', prompt: 'While Layan ___ her homework, the lights went out.', promptAr: 'بينما كانت ليان ___ واجبها انقطعت الكهرباء.', options: ['is doing', 'has done', 'was doing', 'did'], answer: 2, explainAr: 'While + الماضي المستمر لحدث طويل كان جارياً، ثم الماضي البسيط (went out) للحدث القصير الذي قطعه: was doing.' },
        { n: 15, kind: 'mcq', topic: 'tense', prompt: 'Mouayyad ___ his leg while he was playing football yesterday.', promptAr: 'مؤيّد ___ ساقه بينما كان يلعب كرة القدم البارحة.', options: ['hurt', 'hurts', 'has hurt', 'was hurting'], answer: 0, explainAr: 'حدث قصير انتهى في الماضي (yesterday) وقع أثناء حدث طويل (was playing)، فنستخدم الماضي البسيط: hurt (فعل شاذ: hurt – hurt – hurt).' },
        { n: 16, kind: 'mcq', topic: 'tense', prompt: 'Have you ever ___ in a hot-air balloon?', promptAr: 'هل سبق أن ___ في منطاد هوائي؟', options: ['fly', 'flown', 'flew', 'flying'], answer: 1, explainAr: 'المضارع التام للتجارب حتى الآن: have + التصريف الثالث. تصريف fly هو fly – flew – flown، فنقول: Have you ever flown.' },
        { n: 17, kind: 'mcq', topic: 'reported', prompt: '"I will call you tomorrow." Basel told me that he ___ me the following day.', promptAr: '"سأتصل بك غداً." أخبرني باسل أنه ___ بي في اليوم التالي.', options: ['called', 'calls', 'will call', 'would call'], answer: 3, explainAr: 'في الكلام المنقول يتغيّر will إلى would، و tomorrow إلى the following day: he would call me.' },
        { n: 18, kind: 'mcq', topic: 'reported', prompt: '"We have visited the ancient citadel." The tourists said that they ___ the ancient citadel.', promptAr: '"لقد زرنا القلعة القديمة." قال السيّاح إنهم ___ القلعة القديمة.', options: ['were visiting', 'visit', 'have visited', 'had visited'], answer: 3, explainAr: 'في الكلام المنقول يرجع المضارع التام (have visited) إلى الماضي التام: had visited، و we تصبح they.' },
        { n: 19, kind: 'mcq', topic: 'tense', prompt: 'When we arrived at the station, the train ___.', promptAr: 'عندما وصلنا إلى المحطة كان القطار ___.', options: ['is leaving', 'had already left', 'has already left', 'already leaves'], answer: 1, explainAr: 'مغادرة القطار حدثت قبل وصولنا (وهو حدث ماضٍ)، فالحدث الأسبق يكون بالماضي التام: had already left.' },
        { n: 20, kind: 'mcq', topic: 'conditional', prompt: 'If I ___ a lot of money, I would build a new school in my village.', promptAr: 'لو ___ الكثير من المال لبنيت مدرسة جديدة في قريتي.', options: ['had', 'have', 'would have', 'will have'], answer: 0, explainAr: 'الشرط الثاني (موقف خيالي): If + الماضي البسيط، ثم would + الفعل. لذلك: If I had.' },
        { n: 21, kind: 'mcq', topic: 'conditional', prompt: 'If Bayan knew the answer, she ___ you.', promptAr: 'لو كانت بيان تعرف الجواب ___ لك.', options: ['tells', 'will tell', 'would tell', 'told'], answer: 2, explainAr: 'الشرط الثاني: جملة If بالماضي (knew)، والجواب would + الفعل المجرّد: would tell.' },
        ...
        { n: 23, kind: 'mcq', topic: 'pronunciation', prompt: 'The word that has silent "h" is:', promptAr: 'الكلمة التي فيها حرف "h" صامت هي:', options: ['hour', 'happy', 'house', 'hotel'], answer: 0, explainAr: 'hour تُلفظ /aʊə/ ولا يُلفظ فيها h، أما hotel و house و happy فيُلفظ فيها h.' },
        { n: 24, kind: 'mcq', topic: 'pronunciation', prompt: 'The letter "c" is pronounced /s/ in:', promptAr: 'الحرف "c" يُلفظ /s/ في:', options: ['cake', 'clock', 'city', 'cup'], answer: 2, explainAr: 'يُلفظ c صوت /s/ إذا جاء بعده i أو e أو y كما في city. وفي cake و clock و cup يُلفظ /k/.' },
        { n: 25, kind: 'mcq', topic: 'pronunciation', prompt: 'The word that has the short /u/ sound is:', promptAr: 'الكلمة التي فيها الصوت القصير /u/ هي:', options: ['pool', 'spoon', 'tooth', 'foot'], answer: 3, explainAr: 'foot تُلفظ بالصوت القصير /u/، أما pool و spoon و tooth فبالصوت الطويل /u:/.' },
        ...
        { n: 27, kind: 'mcq', topic: 'vocab', prompt: 'A thing that you buy to remind yourself of a place:', promptAr: 'شيء تشتريه ليذكّرك بمكان ما:', options: ['suitcase', 'parcel', 'souvenir', 'passport'], answer: 2, explainAr: 'souvenir = تذكار، وهو شيء نشتريه ليذكّرنا بمكان زرناه (كلمة من الوحدة الثالثة).' },
        { n: 28, kind: 'mcq', topic: 'vocab', prompt: 'Very sad and without hope:', promptAr: 'حزين جداً وبلا أمل:', options: ['depressed', 'motivated', 'satisfied', 'honest'], answer: 0, explainAr: 'depressed = مكتئب، حزين جداً وبلا أمل (كلمة من الوحدة الثانية).' },
        { n: 29, kind: 'mcq', topic: 'vocab', prompt: 'A person trained to give advice is called ___.', promptAr: 'الشخص المدرَّب على تقديم النصيحة يسمّى ___.', options: ['customer', 'founder', 'bully', 'counselor'], answer: 3, explainAr: 'counselor = مرشد / مستشار، شخص مدرَّب على تقديم النصح (كلمة من الوحدة الخامسة).' },
        { n: 30, kind: 'mcq', topic: 'vocab', prompt: 'Something done successfully is known as ___.', promptAr: 'الشيء الذي يُنجَز بنجاح يُعرف بـ ___.', options: ['profile', 'achievement', 'strategy', 'risk'], answer: 1, explainAr: 'achievement = إنجاز، أي شيء أُنجز بنجاح (كلمة من الوحدة السادسة).' },
      ],
    },
    {
      letter: 'D',
      ...
      marks: 40,
      questions: [
        { n: 31, kind: 'ask', prompt: 'Hala lives {in Homs}.', promptAr: 'تعيش هالة في حمص.', options: ['Where Hala lives?', 'What does Hala live?', 'Where does Hala live?', 'Where does Hala lives?'], answer: 2, explainAr: 'نسأل عن المكان بـ Where، والفعل مضارع بسيط مع هي، فنستخدم does + الفعل المجرّد: Where does Hala live?' },
        { n: 32, kind: 'ask', prompt: '{Basel} won the first prize.', promptAr: 'فاز باسل بالجائزة الأولى.', options: ['What won the first prize?', 'Who did win the first prize?', 'Who did Basel win?', 'Who won the first prize?'], answer: 3, explainAr: 'نسأل عن الفاعل (شخص) بـ Who، وعندما تكون Who هي الفاعل لا نستخدم did ويبقى الفعل بالماضي: Who won the first prize?' },
        { n: 33, kind: 'ask', prompt: 'The students visited the museum {last Friday}.', promptAr: 'زار الطلاب المتحف يوم الجمعة الماضي.', options: ['When did the students visit the museum?', 'When the students visited the museum?', 'Where did the students visit?', 'When did the students visited the museum?'], answer: 0, explainAr: 'نسأل عن الزمن بـ When، والجملة في الماضي فنستخدم did + الفعل المجرّد (visit لا visited): When did the students visit the museum?' },
        { n: 34, kind: 'ask', prompt: 'Layan bought {three} souvenirs.', promptAr: 'اشترت ليان ثلاثة تذكارات.', options: ['How many souvenirs did Layan buy?', 'What did Layan buy?', 'How many souvenirs Layan bought?', 'How much souvenirs did Layan buy?'], answer: 0, explainAr: 'نسأل عن العدد مع اسم معدود بالجمع بـ How many، ثم did + الفاعل + الفعل المجرّد: How many souvenirs did Layan buy?' },
      ],
    },
    {
      letter: 'E',
